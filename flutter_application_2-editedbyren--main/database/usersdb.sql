...
SELECT 
    ...
    'new',
    'https://your-project.supabase.co/storage/v1/object/public/scholarship_bucket/STU-' || u.user_id || '/school_id.jpg',
    'https://your-project.supabase.co/storage/v1/object/public/scholarship_bucket/STU-' || u.user_id || '/id_picture.jpg',
    'https://your-project.supabase.co/storage/v1/object/public/scholarship_bucket/STU-' || u.user_id || '/birth_cert.jpg',
    'https://your-project.supabase.co/storage/v1/object/public/scholarship_bucket/STU-' || u.user_id || '/grades.jpg',
    'https://your-project.supabase.co/storage/v1/object/public/scholarship_bucket/STU-' || u.user_id || '/cor.jpg',
    'approved'
FROM users u
