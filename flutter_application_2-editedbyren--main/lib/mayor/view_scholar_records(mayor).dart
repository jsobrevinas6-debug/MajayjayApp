...
class _ScholarRecordsScreenState extends State<ScholarRecordsScreen> {
  ...
  void _sortApplications(int columnIndex, bool ascending) {
    setState(() {
      ...
      final combined = [..._applications, ..._renewals];
      combined.sort((a, b) {
        dynamic aValue, bValue;
        switch (columnIndex) {
          case 0: aValue = a['idNum']; bValue = b['idNum']; break;
      ...
      _applications = combined.where((item) => item['type'] == 'Application').toList();
      _renewals = combined.where((item) => item['type'] == 'Renewal').toList();
    });
  }
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                if (app['type'] == 'Renewal') _buildDocumentRow('📄 COR', app['cor']),
              ],
            ),
          ),
        ),
