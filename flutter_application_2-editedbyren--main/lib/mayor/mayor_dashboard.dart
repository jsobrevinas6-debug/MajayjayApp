  ...
  Future<void> _loadStatistics() async {
    try {
      ...
      setState(() {
        ...
        _approvedRenewals = renewals.where((r) => r['status']?.toString().toLowerCase() == 'approved').length;
        _pendingRenewals = renewals.where((r) => r['status']?.toString().toLowerCase() == 'pending').length;
        _rejectedRenewals = renewals.where((r) => r['status']?.toString().toLowerCase() == 'rejected').length;
